...
function NewSessionWizard() {
    ...
    const [modelMode, setModelMode] = React.useState<ModelMode>(() => {
        ...
        const validCodexModes: ModelMode[] = ['gpt-5.3-codex-high', 'gpt-5.3-codex-medium', 'gpt-5.3-codex-low', 'gpt-5-codex-high', 'gpt-5-codex-medium', 'gpt-5-codex-low', 'gpt-5-minimal', 'gpt-5-low', 'gpt-5-medium', 'gpt-5-high'];
        ...
        return agentType === 'codex' ? 'gpt-5.3-codex-high' : agentType === 'gemini' ? 'gemini-2.5-pro' : 'default';
    });
    ...
    React.useEffect(() => {
        ...
        if (!isValidForCurrentAgent) {
            ...
            if (agentType === 'codex') {
                setModelMode('gpt-5.3-codex-high');
            } else if (agentType === 'gemini') {
