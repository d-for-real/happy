                    ...
                    <View>
                        ...
                        <ItemGroup title="Model Mode">
                            {(agentType === 'claude' ? [
                                ...
                                { value: 'gpt-5.4', label: 'GPT-5.4', description: 'Latest frontier coding model', icon: 'diamond-outline' },
                                { value: 'gpt-5.4-mini', label: 'GPT-5.4 Mini', description: 'Smaller, faster coding model', icon: 'speedometer-outline' },
                            ] as const).map((option, index, array) => (
                                <Item
                                    key={option.value}
                                    title={option.label}
