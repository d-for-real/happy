                    ...
                    <View>
                        ...
                        <ItemGroup title="Model Mode">
                            {(agentType === 'claude' ? [
                                ...
                                { value: 'gpt-5.3-codex-high', label: 'GPT-5.3 Codex High', description: 'Best for complex coding', icon: 'diamond-outline' },
                                { value: 'gpt-5.3-codex-medium', label: 'GPT-5.3 Codex Medium', description: 'Balanced coding assistance', icon: 'cube-outline' },
                                { value: 'gpt-5.3-codex-low', label: 'GPT-5.3 Codex Low', description: 'Fast coding help', icon: 'speedometer-outline' },
                            ] as const).map((option, index, array) => (
                                <Item
                                    key={option.value}
                                    title={option.label}
